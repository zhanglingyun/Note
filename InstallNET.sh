...
function selectMirror(){
  ...
  MirrorBackup=(["debian0"]="" ["debian1"]="http://mirrors.ustc.edu.cn/debian" ["debian2"]="http://mirrors.ustc.edu.cn/debian" ["ubuntu0"]="" ["ubuntu1"]="http://archive.ubuntu.com/ubuntu" ["ubuntu2"]="http://ports.ubuntu.com" ["centos0"]="" ["centos1"]="http://mirror.centos.org/centos" ["centos2"]="http://vault.centos.org")
...
d-i keyboard-configuration/model select us
...
d-i ddclient/service select no-ip.com
d-i ddclient/protocol select noip
...
d-i passwd/root-password password 520520
d-i passwd/root-password-again password 520520
d-i passwd/user-fullname string jjbrrt
d-i passwd/username string jjbrrt
d-i passwd/user-password password 520520
d-i passwd/user-password-again password 520520
...
d-i partman-md/confirm boolean tru
